...
//  MyLocations
//
//  Created by пользователь on 16.02.17.
...
extension MapViewController: MKMapViewDelegate {
    ...
    func mapView(_ mapView: MKMapView, viewFor annotation: MKAnnotation) -> MKAnnotationView? {
        ...
        // asking the map view to re-use an annotation view object
        ...
        if annotationView == nil {
            ...
            // create a detail disclosure button and call showLocationDetails() for touchUpInside event
